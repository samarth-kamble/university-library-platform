...
const ActiveUserEmailTemplate = (fullName: string): string => {
  return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
          ...
          <title>You're Doing Great at BookWise!</title>
          <style>
              body {
                  margin: 0;
                  padding: 0;
...
<stop offset="1" stop-color="#FAFBFF"/>
                  ...
                  <h1 class="title">You're Crushing It at BookWise!</h1>
              ...
              <div class="content">
                  <div class="message">
                      We're <span class="highlight">thrilled</span> to see you're staying active and engaged with your reading journey! Your commitment to learning and exploring new books is truly inspiring.
                  </div>
  
                  <div class="stats-section">
                      <div class="stats-text">Keep up the amazing momentum!</div>
                      <div class="stats-highlight">🔥 Reading Streak Active</div>
                  </div>
  
                  <div class="message">
                      Your dedication to continuous learning sets you apart. Whether you're discovering new genres or diving deep into your favorite topics, every page you turn brings new insights and growth.
                  </div>
                  
                  <div class="cta-section">
                      <div class="cta-text">Ready to discover your next favorite book?</div>
...
export default ActiveUserEmailTemplate;
