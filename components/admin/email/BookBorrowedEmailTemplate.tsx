...
const BookBorrowedEmailTemplate = ({
  fullName,
  bookTitle,
  borrowDate,
  dueDate,
}: BookBorrowedData): string => {
  return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
...
<stop offset="1" stop-color="#FAFBFF"/>
              ...
              <div class="content">
                  <div class="message">
                      You've successfully borrowed <span class="book-title">${bookTitle}</span>. Here are the details:
                  </div>
  
                  <div class="details-section">
                      <ul class="details-list">
                          <li class="details-item">
                              <div class="details-bullet"></div>
                              <span class="details-label">Borrowed On:</span>
                              <span class="details-value">${borrowDate}</span>
                          </li>
                          <li class="details-item">
                              <div class="details-bullet"></div>
                  ...
                  <div class="cta-section">
                      <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://bookwise.com"}/borrowed-books" class="cta-button">
                          View Borrowed Books
                      </a>
                  </div>
              </div>
...
export default BookBorrowedEmailTemplate;
